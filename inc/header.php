    ...
    <header class="d-flex pb-2 flex-wrap align-items-center justify-content-center justify-content-md-between mb-4 border-bottom">
        ...
        <div class="col-md-2 text-end">
            ...
            if (!isset($_COOKIE['user'])) {
                echo ("<button type='button' onclick='window.location.href=\"/login/\"' class='btn btn-outline-primary me-2 fs-5'>Войти</button>");
            } else {
                echo ("<button type='button' onclick='window.location.href=\"/profile/\"' class='btn btn-primary me-2 fs-5'>Профиль</button>");
            }
            ?>
        </div>
    </header>
